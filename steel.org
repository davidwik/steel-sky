...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (defvar steel-theme 'doom-city-lights)
  ...
  (defvar steel-org-dir "~/org-sphere")
...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package org
    ...
    (custom-set-faces
     '(org-block ((t (:family "Envy Code R" :height 120 :background "#181C24")))))
...
#+BEGIN_SRC emacs-lisp :tangle yes
  ...
  (setq org-todo-keywords
        '((sequence "TODO(t)" "|" "DONE(d)")
          (sequence "REPORT(r)" "BUG(b)" "NEEDINFO(i)" "WAITING(w)" "KNOWNCAUSE(k)" "|" "FIXED(f)")))
