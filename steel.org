...
#+BEGIN_SRC emacs-lisp :tangle yes
  (use-package dashboard
    ...
    :init (progn
            ...
            (setq dashboard-banner-logo-title "Steel sky, steel dreams")
            (setq dashboard-startup-banner "~/.emacs.d/logo.png")
            (setq dashboard-items '((recents  . 20)))
            (setq dashboard-init-info "Note this is suited for David's strange liking! Feel free to tweak, or twerk.")
            (setq dashboard-footer-messages '("What is this weird shit you've been working on!?"))
